---
title: "Demo of `bouldr`: a ROC Extender Package"
...
## Adding Race as covariate

```{r}
bd.race <- bouldr(dat = jpp.dat, f = MoodDiagnosis ~ Score + Measure + Race,
             test = 'delong',
             levels = c(0,1),
              direction = "<")
```
